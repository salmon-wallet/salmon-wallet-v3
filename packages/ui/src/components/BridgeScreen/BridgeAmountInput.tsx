 ...
 * Reuses SwapAmountInput styling with bridge-specific features
 */
export const BridgeAmountInput: React.FC<BridgeAmountInputProps> = ({
  label,
  value,
  onChangeValue,
  token,
  ...
  const showMinAmountWarning = minAmount !== undefined && value && parseFloat(value) < minAmount;
