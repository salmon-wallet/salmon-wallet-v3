...
**Package:** `packages/shared` (action already exists, derivation in `utils/derived-accounts.ts`), `packages/ui` (shared component), `apps/mobile`, `apps/extension`, `apps/web`
